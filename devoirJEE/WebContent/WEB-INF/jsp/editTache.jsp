		...
		<nav class="col-md-2 d-none d-md-block bg-light sidebar">
			...
			<div
				...
				<div class="btn-toolbar mb-2 mb-md-0">
					<form method="POST" action="SupprimerTache">
						<input type="hidden" name="id" value="${requestScope.tache.id }">
				...
				<div class="form-row">
					...
					<div class="form-group col-md-6">
						<label for="">Description</label> <input name="description"
							type="text" class="form-control" id="" value="${requestScope.tache.description }" required>
					</div>
				...
				<div class="form-row">
					<div class="form-group col-md-2">
						<label for="">Durée</label> <input type="text" name="duree"
							class="form-control" id="" value="${requestScope.tache.duree}" required>
					</div>

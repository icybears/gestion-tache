			...
			<form action="AjouterProjet" method="POST">
				<div class="form-row">
					...
					<div class="form-group col-md-6">
						...
						<input type="text" name="intitule" class="form-control" id="" required/>
					</div>
				...
				<div class="form-row">
					...
					<div class="form-group col-md-3">
						<label for="">Charge horaire</label> <input type="number" name="chargeHoraire"

			...
			<div
				...
				<div class="btn-toolbar mb-2 mb-md-0">
					<div class="btn-group mr-2">
						...
						<form method="GET" action="AjouterUtilisateur">
					...
					<tbody>
						<c:forEach items="${requestScope.utilisateurs}" var="utilisateur">
							<tr>
								...
								<td><c:out value="${utilisateur.role.getRoleName()}"></c:out></td>
								<td><c:url value="/ModifierUtilisateur"
										var="modifierUtilisateur">
										<c:param name="id" value="${utilisateur.id }" />
									</c:url> <a href="${modifierUtilisateur }">Gérer</a></td>
							</tr>
						</c:forEach>
					</tbody>
				</table>
